...
CREATE TABLE trn_outgoing_items (
    ...
    CONSTRAINT fk_trn_outgoing_items_color_id FOREIGN KEY (color_id) REFERENCES mst_colors(id) ON DELETE SET NULL,
    CONSTRAINT fk_trn_outgoing_items_motif_id FOREIGN KEY (motif_id) REFERENCES mst_motifs(id) ON DELETE SET NULL,
    CONSTRAINT fk_trn_outgoing_items_brand_id FOREIGN KEY (brand_id) REFERENCES mst_brands(id) ON DELETE SET NULL,
    CONSTRAINT fk_trn_outgoing_items_size_id FOREIGN KEY (size_id) REFERENCES mst_sizes(id) ON DELETE SET NULL,
    CONSTRAINT fk_trn_outgoing_items_type_id FOREIGN KEY (type_id) REFERENCES mst_types(id) ON DELETE SET NULL,
...
CREATE TABLE trn_adjusts (
    ...
    CONSTRAINT fk_trn_adjusts_color_id FOREIGN KEY (color_id) REFERENCES mst_colors(id) ON DELETE SET NULL,
    CONSTRAINT fk_trn_adjusts_motif_id FOREIGN KEY (motif_id) REFERENCES mst_motifs(id) ON DELETE SET NULL,
    CONSTRAINT fk_trn_adjusts_brand_id FOREIGN KEY (brand_id) REFERENCES mst_brands(id) ON DELETE SET NULL,
    CONSTRAINT fk_trn_adjusts_size_id FOREIGN KEY (size_id) REFERENCES mst_sizes(id) ON DELETE SET NULL,
    CONSTRAINT fk_trn_adjusts_type_id FOREIGN KEY (type_id) REFERENCES mst_types(id) ON DELETE SET NULL,
