...
$outgoing_item = $db->single('trn_outgoing_items', ['id' => $id]);
$db->query = "Select Result.KodeProduk, Result.NamaProduk, Result.Satuan, SUM(Result.JlhQty)+$outgoing_item->qty As Stok 
From 
(
...
Having SUM(Result.JlhQty) + $outgoing_item->qty >= $data[qty]";
